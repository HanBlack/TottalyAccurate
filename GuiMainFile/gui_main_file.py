...
def game_run():
    ...
    def open_display_characters_window(main_window):
        display_characters_window = tk.Toplevel(main_window)
        party_gui.party_gui(display_characters_window)

    def open_display_characters(main_window):
        main_window.withdraw()
        display_characters_window = party_gui.party_gui()
        display_characters_window.mainloop()
    ...
    recruit_characters_button = ttk.Button(root, text="Recruit Characters",
                                           command=lambda: open_recruit_characters(root))
    recruit_characters_button.pack(padx=20, pady=10)

    display_characters_button = ttk.Button(root, text="Party",
                                           command=lambda: open_display_characters_window(root))
    display_characters_button.pack(padx=20, pady=10)

    items_characters_button = ttk.Button(root, text="Open inventory",
